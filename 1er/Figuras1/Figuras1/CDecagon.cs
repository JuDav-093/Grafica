...
namespace Figuras1
{
    internal class CDecagon
    {
        ...
        //Función que lee los datos de entrada del decágono regular
        ...
        //Función que calcula perímetro decágono regular
        public void PerimeterDecagon()
        {
            mPerimeter = 10 * mLado;
        }
        //función calcula el área del decágono regular
        public void AreaDecagon()
        {
            mArea = (float)(7.6942 * Math.Pow(mLado, 2));
        }
        ...
        //Función que dibuja el decágono regular
