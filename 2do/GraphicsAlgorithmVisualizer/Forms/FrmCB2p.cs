...
{
    public partial class FrmCB2p : Form
    {
        private CurvaB2p pointManager;
        private BezierCurve2 bezierCurve;
        ...
        {
            InitializeComponent();
            pointManager = new CurvaB2p();
            bezierCurve = new BezierCurve2();
        ...
        private void picCanvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (isCurveReady)
            {
                var curve = bezierCurve.CalculateCurve(pointManager.Point1, pointManager.Point2, pointManager.Point3, pointManager.Point4);
                bezierCurve.DrawCurve(g, curve, Color.Orange);
            ...
            using (Brush brush = new SolidBrush(Color.Cyan))
            {
                ...
                if (pointManager.Point4.X != -1) g.FillEllipse(brush, pointManager.Point4.X - 5, pointManager.Point4.Y - 5, 10, 10);
            }
        ...
        private void picCanvas_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (pointManager.SelectedPoint == 0)
            {
                ...
                else if (pointManager.Point3.X == -1) pointManager.Point3 = e.Location;
                else if (pointManager.Point4.X == -1)
                {
                    pointManager.Point4 = e.Location;
                    isCurveReady = true;
                }
            }
        }
